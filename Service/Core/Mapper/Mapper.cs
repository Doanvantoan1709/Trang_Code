...
namespace BaseProject.Service.Core.Mapper
{
    ...
    //        if (!_emittedMappers.TryGetValue(key, out var mapper))
    //        {
    //            lock (_objecLock)
    //            {
    //                if (!_emittedMappers.TryGetValue(key, out mapper))
    //                {
    ...
    //                    mapper = (Action<object, object>)Delegate.CreateDelegate(
    //                        typeof(Action<object, object>), mapMethod);
    //                    _emittedMappers[key] = mapper;
    //                }
    //            }
    //        }
